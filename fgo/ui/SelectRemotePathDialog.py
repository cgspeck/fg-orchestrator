...
class Ui_SelectRemotePathDialog(object):
    def setupUi(self, SelectRemotePathDialog):
        ...
        self.listView = QtWidgets.QListView(SelectRemotePathDialog)
        ...
        self.buttonBox = QtWidgets.QDialogButtonBox(SelectRemotePathDialog)
        ...
        self.buttonBox.accepted.connect(SelectRemotePathDialog.accept)
        self.buttonBox.rejected.connect(SelectRemotePathDialog.reject)
