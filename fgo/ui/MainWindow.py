...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.cbPrimaryAgent = QtWidgets.QComboBox(self.frame_2)
        self.cbPrimaryAgent.setObjectName("cbPrimaryAgent")
        self.formLayout.setWidget(6, QtWidgets.QFormLayout.FieldRole, self.cbPrimaryAgent)
        ...
        MainWindow.setTabOrder(self.tabScenarioSettings, self.tvAgents)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.cbPrimaryAgent.setToolTip(_translate("MainWindow", "Select an agent to be primary, must be online and ready"))
